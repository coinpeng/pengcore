...
In order to support loading of multiple wallets in penguin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is penguin.cpp.
...
Changes to penguin.cpp
----------------------
penguin.cpp is the entry point into penguin-qt, and as such, will require some minor modifications to provide hooks for

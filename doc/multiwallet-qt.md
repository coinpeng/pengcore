...
In order to support loading of multiple wallets in peng-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is peng.cpp.
...
Changes to peng.cpp
----------------------
peng.cpp is the entry point into peng-qt, and as such, will require some minor modifications to provide hooks for

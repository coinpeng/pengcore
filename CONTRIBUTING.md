...
The following applies to code changes to the PENG Core project, and is not to be
confused with overall PENG Network Protocol consensus changes.

Whether a pull request is merged into PENG Core rests with the project merge
...
Patches that change PENG consensus rules are considerably more involved than
...
Where a patch set proposes to change the PENG consensus, it must have been
...
The project leader is the release manager for each PENG Core release.

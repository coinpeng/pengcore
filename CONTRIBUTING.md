Contributing to Penguin Core
============================

The Penguin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Penguin Core project, and is not to be
confused with overall Penguin Network Protocol consensus changes.

Whether a pull request is merged into Penguin Core rests with the project merge
...
Patches that change Penguin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Penguin consensus, it must have been
...
The project leader is the release manager for each Penguin Core release.

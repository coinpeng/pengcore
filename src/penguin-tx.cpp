...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Penguin Core penguin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  penguin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded penguin transaction") + "\n" +
                               "  penguin-tx [options] -create [commands]   " + _("Create hex-encoded penguin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded penguin transaction

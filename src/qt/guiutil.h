...
/** Utility functions used by the Penguin Qt UI.
 */
namespace GUIUtil
{
...
// Render Penguin addresses in monospace font
...
// Parse "penguin:" URI into recipient object, return true on successful parsing

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PENG Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PENG address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and peng: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PENG Core"), this);
    aboutAction->setStatusTip(tr("Show information about PENG Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PENG"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PENG addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PENG addresses"));
    ...
    openAction->setStatusTip(tr("Open a PENG: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PENG Core help message to get a list with possible PENG command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PENG Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PENG network", "", count));
}
...
{
    QString strTitle = tr("PENG Core"); // default title

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Penguin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Penguin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and penguin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Penguin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Penguin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Penguin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Penguin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Penguin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Penguin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Penguin Core help message to get a list with possible Penguin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Penguin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Penguin network", "", count));
}
...
{
    QString strTitle = tr("Penguin Core"); // default title

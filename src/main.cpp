...
#if defined(NDEBUG)
#error "Penguin cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight < 476) {
        ...
        nSubsidy = 850 * COIN;
    } else if (nHeight < 2628001){
        nSubsidy = 800 * COIN;
    } else if (nHeight < 3153601){
        nSubsidy = 750 * COIN;
    } else if (nHeight < 3679201){
        nSubsidy = 700 * COIN;
    } else if (nHeight < 4204801){
        nSubsidy = 650 * COIN;
    } else if (nHeight < 4730401){
        nSubsidy = 600 * COIN;
    } else if (nHeight < 4783001){
        nSubsidy = 550 * COIN;
    } else if (nHeight < 5308601){
        nSubsidy = 500 * COIN;
    } else if (nHeight < 5834201){
        nSubsidy = 450 * COIN;
    } else if (nHeight < 6359801){
        nSubsidy = 400 * COIN;
    } else if (nHeight < 6885401){
        nSubsidy = 350 * COIN;
    } else if (nHeight < 7411001){
        nSubsidy = 300 * COIN;
    } else if (nHeight < 7936601){
        nSubsidy = 250 * COIN;
    } else if (nHeight < 8462201){
        nSubsidy = 200 * COIN;
    } else if (nHeight < 8987801){
        nSubsidy = 150 * COIN;
    } else if (nHeight < 10039001){
        nSubsidy = 100 * COIN;
    } else if (nHeight < 11090201){
        nSubsidy = 50 * COIN;
    } else if (nHeight < 728580000){
        nSubsidy = 50 * COIN;
    } else {
        nSubsidy = 0 * COIN;
    }
...
bool DisconnectBlock(CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool* pfClean)
{
    ...
    for (int i = block.vtx.size() - 1; i >= 0; i--) {
         ...
         * note we only undo zerocoin databasing in the following statement, value to and from Penguin
...
{
    RenameThread("penguin-scriptch");
    scriptcheckqueue.Thread();
}

void RecalculateZPENGMinted()
{
...
void RecalculateZPENGSpent()
{
    ...
    while (true) {
        ...
        //Remove spends from zPENG supply
...
bool RecalculatePENGSupply(int nHeightStart)
{
...
void static UpdateTip(CBlockIndex* pindexNew)
{
    ...
    // If turned on AutoZeromint will automatically convert PENG to zPENG
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // Penguin: We use certain sporks during IBD, so check to see if they are

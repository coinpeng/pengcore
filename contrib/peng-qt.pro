...
RESOURCES += src/qt/peng.qrc src/qt/peng_locale.qrc

TRANSLATIONS += src/qt/locale/peng_bg.ts \
                src/qt/locale/peng_de.ts \
                src/qt/locale/peng_en.ts \
                src/qt/locale/peng_es.ts \
                src/qt/locale/peng_fi.ts \
                src/qt/locale/peng_fr.ts \
                src/qt/locale/peng_it.ts \
                src/qt/locale/peng_ja.ts \
                src/qt/locale/peng_pl.ts \
                src/qt/locale/peng_pt.ts \
                src/qt/locale/peng_ru.ts \
                src/qt/locale/peng_sk.ts \
                src/qt/locale/peng_sv.ts \
                src/qt/locale/peng_vi.ts \
                src/qt/locale/peng_zh_CN.ts \
                src/qt/locale/peng_zh_TW.ts

...
RESOURCES += src/qt/penguin.qrc src/qt/penguin_locale.qrc

TRANSLATIONS += src/qt/locale/penguin_bg.ts \
                src/qt/locale/penguin_de.ts \
                src/qt/locale/penguin_en.ts \
                src/qt/locale/penguin_es.ts \
                src/qt/locale/penguin_fi.ts \
                src/qt/locale/penguin_fr.ts \
                src/qt/locale/penguin_it.ts \
                src/qt/locale/penguin_ja.ts \
                src/qt/locale/penguin_pl.ts \
                src/qt/locale/penguin_pt.ts \
                src/qt/locale/penguin_ru.ts \
                src/qt/locale/penguin_sk.ts \
                src/qt/locale/penguin_sv.ts \
                src/qt/locale/penguin_vi.ts \
                src/qt/locale/penguin_zh_CN.ts \
                src/qt/locale/penguin_zh_TW.ts
